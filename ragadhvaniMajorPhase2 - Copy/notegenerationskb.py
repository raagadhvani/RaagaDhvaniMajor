...
model = Sequential()
model.add(LSTM(50, activation='relu', input_shape=(1, 8)))
model.add(Dense(16, activation='relu'))  # Apply ReLU activation to the Dense layer
model.add(Dense(16))  # Output layer with 8 units since your sequences are of length 8
