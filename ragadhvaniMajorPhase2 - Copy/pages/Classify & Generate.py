...
# Define the content for Shankarabharanam raga
shankarabharanam_content = """
Shankarabharanam, also known as the Shankarabharana raga, is a very popular raga in Carnatic music. It is the 29th melakarta raga in the 72 melakarta raga system. Shankarabharanam is a sampurna raga, meaning it has all seven swaras (notes) in both ascending (arohana) and descending (avarohana) scales.

**Arohana:** S R2 G3 M1 P D2 N3 S \
**Avarohana:** S N3 D2 P M1 G3 R2 S

This raga evokes a sense of devotion and peace. It is often used as the opening piece (Varnam) in a Carnatic music concert. Many famous compositions, including varnams, krithis, and thillanas, have been composed in Shankarabharanam.


"""

# Define the content for Bhavapriya raga
bhavapriya_content = """
Bhavapriya is a raga in Carnatic music that is derived from the 29th melakarta raga, Shankarabharanam. It is the 51st melakarta raga in the 72 melakarta raga system. Bhavapriya is a sampurna raga, meaning it has all seven swaras (notes) in both ascending (arohana) and descending (avarohana) scales.

**Arohana:** S R2 G3 M1 P D2 N3 S \
**Avarohana:** S N3 D2 P M1 G3 R2 S

Bhavapriya has a unique and melodious appeal. It is often used in compositions that express love and devotion. While it shares the same scale as Shankarabharanam, Bhavapriya has its own distinct character and compositions.
...
if uploaded_file is not None:
    ...
    # Create expanders for Shankarabharanam and Bhavapriya
    if(raga == "Shankarabharanam"):
        with st.expander("Learn More about Shankarabharanam"):
            st.write(shankarabharanam_content)
            st.image("Sankarabharanam_scale.gif", caption="Swaras in Shankarabharanam Raga")
    elif(raga == "Bhavapriya"):
        with st.expander("Bhavapriya"):
            st.write(bhavapriya_content)
            st.image("Bhavapriya_scale.png", caption="Swaras in Bhavapriya Raga")
    ...
    if raga =="Shankarabharanam":
        ...
        # Convert the output array to a comma-separated string
        final_composition_filtered_output_string = ', '.join(final_composition)
        st.write(final_composition_filtered_output_string)
